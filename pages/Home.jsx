    ...
    return (
        ...
        <div id="home" className='grid grid-cols-1 bg-beige sm:grid-cols-2 '>
            ...
            <div className=' sm:ml-6 sm:mr-8 text-center mt-10 '>
                <h1 className='font-serif text-beige bg-black text-5xl mb-10 mt-4 text-center sm:text-left sm:text-6xl  sm:mt-8 sm:ml-16 sm:mb-20 md:text-7xl'> Hello, I'm Samina Dahlberg</h1>
                <h4 className='font-sans text-center text-black text-md sm:text-left  sm:ml-16 md:pr-46 lg:text-xl' > I am a frontend developer with an interest in building engaging and intuitive products </h4>
                <h3 className="mt-6 mb-6 text-black text-center sm:text-left sm:ml-16" > I work mostly with:</h3>
